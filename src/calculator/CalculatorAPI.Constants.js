...
exports.VOLUME_UNIT_INFO = [
  ...
  { name: 'Pint(s) US', conversion: 0.473176472745920009839 },
...
exports.HONEY_UNIT_INFO = [
  ...
  { name: 'Cup(s) Metric', conversion: 0.359479282252145832623 },
...
exports.NUTRIENT_REGIMEN_STRING = [
  'TOSNA',
  'Fermaid K + DAP',
  'Blount-Elliott',
  'TOSNA (K)',
...
exports.DRY_FG_OG_VALUES = [1.0, 1.04, 1.1, 1.144];
